...
FLAGS_COMMON_static = $(FLAGS_COMMON) /FD  /D "_STLP_NO_FORCE_INSTANTIATE" /D "_NOTHREADS"
...
CXXFLAGS_DEBUG_static=$(FLAGS_COMMON_static) /MLd $(FLAGS_DEBUG) /Fo"$(DEBUG_OBJDIR_static)\\" /Fd"$(DEBUG_OBJDIR_static)\\"
...
CXXFLAGS_STLDEBUG_static=$(FLAGS_COMMON_static) /MLd $(FLAGS_DEBUG) /D "_STLP_DEBUG" /Fo"$(STLDEBUG_OBJDIR_static)\\" /Fd"$(STLDEBUG_OBJDIR_static)\\"
...
CXXFLAGS_RELEASE_static=$(FLAGS_COMMON_static) /ML $(FLAGS_NDEBUG) /Fo"$(RELEASE_OBJDIR_static)\\" /Fd"$(RELEASE_OBJDIR_static)\\"
